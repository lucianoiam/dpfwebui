...
ifneq ($(HIPHOP_MAX_BASE_WIDTH),)                                             
ifneq ($(HIPHOP_MAX_BASE_HEIGHT),) 
LXHELPER_CPPFLAGS += -DHIPHOP_MAX_BASE_WIDTH=$(HIPHOP_MAX_BASE_WIDTH)
LXHELPER_CPPFLAGS += -DHIPHOP_MAX_BASE_HEIGHT=$(HIPHOP_MAX_BASE_HEIGHT) 
endif
endif
