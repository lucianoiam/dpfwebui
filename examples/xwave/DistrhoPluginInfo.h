 ...
 */
#define DPF_WEBUI_SHARED_MEMORY_SIZE 1048576
...
/**
   ...
   @note DPF_WEBUI_SUPPORT_BSON must be enabled
 */
#define DPF_WEBUI_PROTOCOL_BINARY 1
...
/**
   ...
   @note This macro is required.
 */
#define DISTRHO_PLUGIN_URI "https://lucianoiam.com/dpfwebui/xwave"

/**
   The plugin id when exporting in CLAP format, in reverse URI form.
   @note This macro is required when building CLAP plugins
*/
#define DISTRHO_PLUGIN_CLAP_ID "com.lucianoiam.dpfwebui.xwave"
